...
# System config
use constant ADMIN_PASS => 'ADMIN';			# Admin password. For fucks's sake, change this.
use constant SECRET => 'wowowow';				# Cryptographic secret. CHANGE THIS to something totally random, and long.
...
# Page look
use constant TITLE => 'GuildBoard';	# Name of this image board
